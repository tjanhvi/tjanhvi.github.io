!(function () {
  ...
  e.prototype.indexes.push({
    ...
    selector: function (e) {
      var t;
      if ((t = e.match(n))) return t[0].slice(1);
    },
  });
  var o = /^\.((?:[\w\u00c0-\uFFFF\-]|\\.)+)/g;
  e.prototype.indexes.push({
  ...
  function c(e, t) {
    var r,
      ...
      d = [];
    do {
      if ((s.exec(""), (o = s.exec(u)) && ((u = o[3]), o[2] || !u)))
        for (r = 0; r < l; r++)
          if ((c = (a = e[r]).selector(o[1]))) {
            for (n = d.length, i = !1; n--; )
              if (d[n].index === a && d[n].key === c) {
                i = !0;
                break;
              }
            i || d.push({ index: a, key: c });
            break;
          }
    } while (o);
    return d;
  ...
  (e.prototype.logDefaultIndexUsed = function () {}),
    (e.prototype.add = function (e, t) {
      ...
      if ("string" == typeof e) {
        for (
          ...
          (s = (f = d[n]).key),
            (l = a(h, (o = f.index))) ||
              (((l = Object.create(o)).map = new i()), h.push(l)),
            o === this.indexes.default && this.logDefaultIndexUsed(r),
            (u = l.map.get(s)) || ((u = []), l.map.set(s, u)),
            u.push(r);
        this.size++, v.push(e);
      }
    }),
    (e.prototype.queryAll = function (e) {
      ...
      for (t = 0, n = f.length; t < n; t++)
        for (i = f[t], r = 0, o = (s = this.matches(i)).length; r < o; r++)
          u[(a = s[r]).id]
            ? (c = u[a.id])
            : ((c = {
                id: a.id,
  ...
  var u = null,
    ...
    f = [];
  function h(e, t) {
    d || (d = new MutationObserver(v)),
      u || ((u = e.createElement("div")), d.observe(u, { attributes: !0 })),
      f.push(t),
      u.setAttribute("data-twiddle", "" + Date.now());
  }
  function v() {
    var e = f;
    f = [];
  ...
  function w(e, t) {
    if (t instanceof e.elementConstructor) {
      var r = p.get(t);
      if ((r || ((r = []), p.set(t, r)), -1 === r.indexOf(e.id))) {
        var n = void 0;
        if ((e.initialize && (n = e.initialize.call(void 0, t)), n)) {
          var o = m.get(t);
          o || ((o = {}), m.set(t, o)), (o["" + e.id] = n);
        }
        r.push(e.id);
      }
    }
  ...
  function S(e, t) {
    if (t instanceof e.elementConstructor) {
      var r = g.get(t);
      if ((r || ((r = []), g.set(t, r)), -1 === r.indexOf(e.id))) {
        e.elements.push(t);
        var n = m.get(t),
          o = n ? n["" + e.id] : null;
    ...
    if (r) {
      for (var n = r.slice(0), o = 0; o < n.length; o++) {
        ...
        if (i) {
          ...
          var c = m.get(t),
            a = c ? c["" + i.id] : null;
          a && a.remove && a.remove.call(void 0, t);
          var l = y.get(t),
            u = l ? l["" + i.id] : null;
  ...
  function E(e, t, r) {
    for (var n = 0; n < r.length; n++) {
      ...
      if ("querySelectorAll" in o)
        for (var a = e.selectorSet.queryAll(o), l = 0; l < a.length; l++)
          for (
            var u = a[l], d = u.data, f = u.elements, h = 0;
            h < f.length;
            h++
          )
            t.push([k, f[h], d]);
  ...
  function q(e, t, r) {
    for (var n = 0; n < r.length; n++) {
      ...
      if ("querySelectorAll" in o) {
        t.push([D, o]);
        for (var i = o.querySelectorAll("*"), s = 0; s < i.length; s++)
          t.push([D, i[s]]);
      }
    }
  }
    ...
    if ("querySelectorAll" in r) {
      ...
      if (s)
        for (var c = 0; c < s.length; c++) {
          var a = e.observers[s[c]];
          a &&
            (e.selectorSet.matchesSelector(r, a.selector) || t.push([O, r, a]));
        }
    }
  }
  var N =
  ...
  function F(t) {
    (this.rootNode = 9 === t.nodeType ? t.documentElement : t),
        ...
        function (e, t) {
          ...
          (function (e, t, r) {
            for (var n = 0; n < r.length; n++) {
              var o = r[n];
              "childList" === o.type
                ? (E(e, t, o.addedNodes), q(0, t, o.removedNodes))
                : "attributes" === o.type && I(e, t, o.target);
            }
            !(function (e) {
              if (null === M) {
      ...
      (this._scheduleAddRootNodes = (function (e, t) {
        var r = [];
        function n() {
          var e = r;
          (r = []), t(e);
        ...
        return function () {
          for (var t = arguments.length, o = Array(t), i = 0; i < t; i++)
            o[i] = arguments[i];
          r.push(o), 1 === r.length && h(e, n);
        };
      })(
        this.ownerDocument,
        function (e) {
          var t = [];
          E(e, t, [e.rootNode]), b(e, t);
        }.bind(this, this)
      )),
      (function (e, t) {
        var r = e.readyState;
  ...
  F.prototype.observe = function (e, t) {
    ...
    return (
      this.selectorSet.add(n.selector, n),
      (this.observers[n.id] = n),
  ...
  !(function () {
    var e;
    (C || (C = new F(window.document)), (e = C)).observe.apply(e, arguments);
  })(".js-section-codespaces-develop", (e) => {
    setInterval(() => {
      "white" == document.getElementById("my-training").style.color
      ...
      for (i = 0; i < t.length; i++)
        t[i].classList.toggle("services-flip-box-dark-theme");
